...
assert(routes.includes("This white overlay replaces contractor-only stub content without moving the check face/header/MICR"), "contractor statement reuses the existing stub box without moving check face/header/MICR");
...
assert(routes.includes("PROOF OF PAYMENT"), "contractor statement includes proof of payment details");
assert(routes.includes("No trade compensation applied."), "contractor statement handles absence of trade credit without employee deductions");
