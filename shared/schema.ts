...
export const rolePermissions = pgTable("role_permissions", {
  ...
  canApproveDepartment: boolean("can_approve_department").default(false),
  canApproveCompany: boolean("can_approve_company").default(false),
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const documents = pgTable("documents", {
  ...
  documensoStatus: text("documenso_status"),
  documensoSigningUrl: text("documenso_signing_url"),
  documensoCompletedPdfUrl: text("documenso_completed_pdf_url"),
  documensoAuditUrl: text("documenso_audit_url"),
  sentForSignatureAt: timestamp("sent_for_signature_at"),
  signedAt: timestamp("signed_at"),
  signingProvider: text("signing_provider").default("documenso"),
  signatureRequired: boolean("signature_required").default(false),
  signatureStatus: text("signature_status").default("draft"),
  createdBy: varchar("created_by"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const smsConfig = pgTable("sms_config", {
  ...
  useMessagingService: boolean("use_messaging_service").default(false),
  webhookUrl: text("webhook_url").default("https://mypaylink.app/api/twilio/sms/inbound"),
  webhookFallbackUrl: text("webhook_fallback_url").default("https://mypaylink.app/api/twilio/sms/fallback"),
  statusCallbackUrl: text("status_callback_url").default("https://mypaylink.app/api/twilio/sms/status"),
  isConfigured: boolean("is_configured").default(false),
  lastTestedAt: timestamp("last_tested_at"),
  lastTestResult: text("last_test_result"),
  updatedAt: timestamp("updated_at").defaultNow(),
